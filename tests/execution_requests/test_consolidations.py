...
def test_consolidation_foreign_source_and_target_pubkey_from_user_withdrawal_address(withdrawal_address: str, watcher: WatcherStub):
    ...
    general_user_withdrawal_address_alert = next((alert for alert in watcher.alertmanager.sent_alerts if alert.labels.alertname.startswith('HeadWatcherConsolidationSourceWithdrawalAddress')), None)
