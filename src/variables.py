...
# Refresh the validators index incrementally instead of a full per-epoch scan
VALIDATORS_INDEX_INCREMENTAL = os.getenv('VALIDATORS_INDEX_INCREMENTAL', 'true').lower() == 'true'
VALIDATORS_INDEX_CHUNK_SIZE = int(os.getenv('VALIDATORS_INDEX_CHUNK_SIZE', 8192))
VALIDATORS_INDEX_REFETCH_TAIL = int(os.getenv('VALIDATORS_INDEX_REFETCH_TAIL', 256))
